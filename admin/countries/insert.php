    ...
    <main role="main" class="mb-2">
        ...
        <div class="container mt-2">
            <div class="full borderf">
                <h1 class="tieu-de">Quản lý Thêm Quốc gia Phim</h1>
            </div>
            <?php
        ...
        <div class="container">
            <div class="full borderf">
                <h3 class="text-movies">Thêm Quốc gia Phim</h3>
            </div>
            <br>
            <div class="row">
                <div class="col">
                    <form name="frmThemMoi" id="frmThemMoi" method="post" action="" enctype="multipart/form-data">
                        <div class="form-row">
                            <div class="form-group col-12">
                                ...
                                <input type="text" class="form-control" id="countries_title" name="countries_title" placeholder="Tên Quốc gia Phim" value="">
                            </div>
                        </div>
                        <div class="form-row">
                            <div class="form-group col-12">
                                ...
                                <select class="form-control" id="countries_status" name="countries_status">
                                    <option value="<?= $dataPhim['countries_status'] = 1 ?>">Đã duyệt</option>
                                    <option value="<?= $dataPhim['countries_status'] = 2 ?>">Chưa duyệt</option>
                                </select>
                            </div>
                        </div>
                        <div class="form-row">
                            <div class="form-group col">
                                ...
                                <textarea class="form-control" id="countries_description" name="countries_description" placeholder="Mô tả Quốc gia Phim" rows="10"></textarea>
                            </div>
                        </div>
            ...
            if (
                ...
                $sqlThemMoiQuocGia = <<<EOT
                INSERT INTO countries(title, description, status)
                VALUES ('$countries_title', '$countries_description', '$countries_status');
EOT;
                // 5. Thực thi câu truy vấn SQL để lấy về dữ liệu
                mysqli_query($conn, $sqlThemMoiQuocGia) or die("<b>Có lỗi khi thực thi câu lệnh SQL: </b>" . mysqli_error($conn) . "<br /><b>Câu lệnh vừa thực thi:</b></br>$sqlThemMoiQuocGia");
